...
export function AppetizerBarCTA() {
  const navigateToContactForm = () => {
    trackCtaFormClick("cta_barra_aperitivos");
      ...
      <div className="w-full max-w-7xl mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-lg md:text-xl text-accent max-w-3xl mx-auto leading-relaxed">
            No dejes que se agoten las fechas. Reserva tu barra de aperitivos
            gourmet hoy mismo y asegura el éxito de tu evento con elpernilet.
          </p>
        </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-green-100 text-sm">
                        Chefs certificados con amplia trayectoria
                      </div>
                    </div>
                  </div>
