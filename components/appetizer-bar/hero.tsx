...
export function AppetizerBarHero() {
  ...
  const navigateToContactForm = () => {
    trackCtaFormClick("hero_barra_aperitivos");
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif font-bold text-foreground mb-6 leading-tight">
              ...
              <span className="block text-green-700">para Bodas y Eventos</span>
            </h1>
            ...
            <div className="flex flex-col gap-3">
              <Button
                ...
                size="lg"
                className="text-lg px-8 py-6 bg-green-700 hover:bg-green-800 cursor-pointer w-fit"
              >
            ...
            <div className="mt-8 pt-8 border-t border-green-100">
              ...
              <div className="flex flex-wrap gap-2">
                {visibleTrustedBy.map((name) => (
                  <span
                    key={name}
                    className="px-3 py-1 rounded-full border border-green-200 bg-white/70 text-xs md:text-sm font-medium text-foreground"
                  >
                    {name}
                  </span>
                ))}
              ...
              {trustedBy.length > 5 && (
                <button
                  ...
                  className="mt-3 text-sm font-medium text-green-700 hover:text-green-800 cursor-pointer"
                >
