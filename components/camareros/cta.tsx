...
export function WaitersCTA() {
  const navigateToContactForm = () => {
    trackCtaFormClick("cta_camareros");
      ...
      <div className="w-full max-w-7xl mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-lg md:text-xl text-accent max-w-3xl mx-auto leading-relaxed">
            No dejes que se agoten las fechas. Reserva tu servicio de camareros
            profesionales hoy mismo y asegura el éxito de tu evento con
            elpernilet.
          </p>
        </div>
