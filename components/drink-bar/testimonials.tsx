...
export function DrinkBarTestimonials() {
  const navigateToContactForm = () => {
    trackCtaFormClick("testimonials_barra_bebidas");
        ...
        <div className="w-full max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {testimonials.map((testimonial, index) => (
              <Card
                key={index}
                className="border-2 border-blue-50 hover:border-blue-200 transition-all duration-300 hover:shadow-lg"
              >
          ...
          <div className="mt-16 bg-gradient-to-r from-blue-700 to-blue-800 rounded-2xl p-8 md:p-12 text-white">
            ...
            <div className="grid md:grid-cols-4 gap-8 text-center">
              ...
              <div>
                ...
                <div className="text-blue-100">Puntuación Media</div>
              </div>
              <div>
              ...
              <div>
                ...
                <div className="text-blue-100">Clientes Repetidores</div>
              </div>
            </div>
