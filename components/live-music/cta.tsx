      ...
      <div className="w-full max-w-7xl mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-lg md:text-xl text-accent max-w-3xl mx-auto leading-relaxed">
            No dejes que se agoten las fechas. Reserva tu música en directo hoy
            mismo y da vida a tu evento con elpernilet.
          </p>
        </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-amber-100 text-sm">
                        Red de músicos profesionales en toda España
                      </div>
                    </div>
                  </div>
        ...
        <div className="mt-16 text-center">
          <div className="bg-white/10 rounded-2xl p-8 md:p-12 border border-white/20">
            ...
            <p className="text-amber-100 mb-6 max-w-2xl mx-auto">
              Las mejores fechas y los mejores músicos se agotan rápido,
              especialmente en temporada alta. No esperes más.
            </p>
          </div>
        </div>
      </div>
